...
wg = open(filename, 'w')
wg.write("[Interface]\n")
wg.write("PrivateKey = cNsUyqp5FAgGHdDX8ug07xWjK6mDc7crf6qAZE+vrXQ= \n")
wg.write("ListenPort = " + str(int(asn % 100000)) + "\n")
wg.write("Table = off\n")
wg.write("PostUp = ip addr add fe80::826/64 dev %i\n")
wg.write("PostUp = ip addr add fd11:552f:74db::5/128 dev %i\n")
if ipv4 != "0":
    wg.write("PostUp = ip addr add 172.23.196.5 peer " + ipv4 + " dev %i\n")
...
bird.write("    source address fe80::826;\n")
bird.write("};\n")
bird.close()
