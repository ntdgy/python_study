...
class DBMS(object):
    ...
    def newDB(self):
        ...
        self.tree['client_enterprise'] = {'id': {}, 'name': {}, 'supply_center_id': {}, 'country': {}, 'city': {},
                                          'industry': {}, 'len': 0}
        self.tree['salesman'] = {'id': {}, 'name': {}, 'number': {}, 'gender': {}, 'age': {}, 'mobile_number': {},
                                 'len': 0}
        ...
        self.tree['contract_content'] = {'id': {}, 'contract_id': {}, 'product_model_id': {}, 'quantity': {},
                                         'estimated_delivery_date': {}, 'lodgement_date': {}, 'salesman_id': {},
                                         'len': 0}
...
if __name__ == '__main__':
    ...
    print(
        a.excuse("select * from supply_center where id = '2' and director_name = 'test' or supply_center = 'center';"))
    a.close()
