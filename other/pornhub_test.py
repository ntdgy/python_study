...
def index(url, file_name):
    ...
    while True:
        try:
            ...
            res = requests.get(url, proxies=proxy,headers=headers).text
            break
...
if __name__ == '__main__':
    title, full_url = index('https://cn.pornhub.com/view_video.php?viewkey=ph5bd4e44badd9f','1')
    print(title)
    print(full_url)
    print(index('https://cn.pornhub.com/view_video.php?viewkey=ph5bd4e44badd9f','1'))