...
def test_update(update_supply_center: list, update_client_enterprise: list, update_salesman: list,
    ...
    with open('log.txt', 'a') as f:
        f.write(string + 'update supply_center: %f\n' % (end - start))
    ...
    with open('log.txt', 'a') as f:
        f.write(string + 'update client_enterprise: %f\n' % (end - start))
    ...
    with open('log.txt', 'a') as f:
        f.write(string + 'update salesman: %f\n' % (end - start))
    ...
    with open('log.txt', 'a') as f:
        f.write(string + 'update product: %f\n' % (end - start))
    ...
    with open('log.txt', 'a') as f:
        f.write(string + 'update product_model: %f\n' % (end - start))
    ...
    with open('log.txt', 'a') as f:
        f.write(string + 'update contract: %f\n' % (end - start))
    ...
    with open('log.txt', 'a') as f:
        f.write(string + 'update contract_content: %f\n' % (end - start))
    print('%s update_contract_content:' % string, end - start)
    end1 = time.time()
    with open('log.txt', 'a') as f:
        f.write(string + 'update: %f\n' % (end1 - start1))
